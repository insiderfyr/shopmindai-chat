// ========== src/components/atoms/ShopMindLogo.tsx ==========

import React from 'react'

interface ShopMindLogoProps {
  size?: number
}

export const ShopMindLogo = React.memo(({ size = 32 }: ShopMindLogoProps) => (
  <svg 
    version="1.1" 
...
ShopMindLogo.displayName = 'ShopMindLogo'